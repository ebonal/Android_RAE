...
public class ImagesDebugActivity extends Activity implements CursorHolder, LoaderHolder
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_images_debug);
	
		ListView listView = (ListView)findViewById(R.id.listViewImage) ;
    	cursorAdapter = new ImagesDebugAdapter(this) ;
